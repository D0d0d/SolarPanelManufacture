...
supplier1 = Supplier(name="Supplier1", time=5, price=5, products={"comp1": 60})
supplier1.add_production_facility(Line1, {"comp1": 20})
model = ProductionModel({supplier1}, [Line1])
#endregion
