...
supplier1 = Supplier(name="Supplier1", time=5, price=5, products=[{'name': 'chip',      'price': [40, 100],     'amount': 960,  'quality':0.9},
                                                                  {'name': 'glass',     'price': [400, 600],    'amount': 32,   'quality':0.9},
                                                                  {'name': 'contacts',  'price': [30, 60],      'amount': 800,  'quality':0.9},
                                                                  {'name': 'wires',     'price': [10, 80],      'amount': 400,  'quality':0.9},
                                                                  {'name': 'mounting',  'price': [200, 400],    'amount': 16,   'quality':0.9},
                                                                  {'name': 'frame',     'price': [400, 1000],   'amount': 16,   'quality':0.9},
                                                                  {'name': 'film',      'price': [40, 100],     'amount': 1,    'quality':0.9},
                                                                  {'name': 'box',       'price': [400, 4000],   'amount': 1,    'quality':0.9}])
#endregion
#region Инициализация склада
Storage = Storage(max=50, workers=1)
Storage.add_production_facility(Line1, Line1.componetns)
#endregion
